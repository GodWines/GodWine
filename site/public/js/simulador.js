function simular() {
    ...
    opacidade.innerHTML =` <img src="./assets/telaSimulador/barris.png" alt="" class="imgFundo" style="opacity: 0.2;"> `

    div_resultado.innerHTML = `<div style=" border: 0.1vw solid rgb(255, 196, 0);"> <span style="color:red">Sem os nossos sensores:</span><br>
    Estipula-se atualmente que o mercado de vinhos há uma perda considerável de <span style="color:red"> 25% </span> nas vinicolas pela falta de controle de temperatura e umidade. <br>
